...
class logo(MovingCameraScene):
    ...
    def construct(self):
        ...
        triangulos2=[]
        for i in range(6):
            cuadrados.append(Polygon(*position_list_square, color=BLACK).set_fill(color=BLACK, opacity=0))
            triangulos.append(Polygon(*position_list_triangle1, color=BLACK).set_fill(color=BLACK, opacity=0))
            triangulos2.append(Polygon(*position_list_triangle2, color=BLACK).set_fill(color=BLACK, opacity=0))
